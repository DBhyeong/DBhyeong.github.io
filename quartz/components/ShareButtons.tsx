...
const ShareButtons: QuartzComponent = ({ displayClass, fileData }: QuartzComponentProps) => {
  ...
  return (
    <div class={classNames(displayClass, "share-buttons")} data-title={title}>
      ...
      <button class="sb-btn sb-kakao" data-share="kakao" title="카카오톡 공유" aria-label="카카오톡 공유">
        💬 카카오톡
      </button>
      <button class="sb-btn sb-x" data-share="x" title="X(트위터) 공유" aria-label="X 공유">
        𝕏
      </button>
      <button class="sb-btn sb-fb" data-share="facebook" title="페이스북 공유" aria-label="페이스북 공유">
        f
      </button>
      <button class="sb-btn sb-li" data-share="linkedin" title="링크드인 공유" aria-label="링크드인 공유">
        in
      </button>
