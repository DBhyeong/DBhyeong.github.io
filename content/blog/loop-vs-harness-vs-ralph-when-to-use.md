...
세 기법을 속성으로 나란히 두면 차이가 더 또렷해진다.

| 기법 | 등장 시점 | 해결한 '반복 고통' | 포커스 | 언제 쓰나 |
|---|---|---|---|---|
| **① 랄프 루프** | 가장 먼저 | 매번 "다음 작업"을 사람이 시켜야 함 | 진행(0→10) | 작업을 잘게 쪼개 무인 반복 |
| **② 하네스 엔지니어링** | 그다음 | "이건 하지 마"를 매번 말해야 함 | 범위·제약 정의 | 오래 작업 중 선을 안 넘게 |
| **③ 루프 엔지니어링** | 가장 최근 | "더 고쳐"를 매번 반복해야 함 | 완성도 자동 상승 | 측정 가능한 목표를 100%까지 무인 |
